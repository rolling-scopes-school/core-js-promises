...
1. Install Node.js
2. Fork this repository: https://github.com/rolling-scopes-school/core-js-promises
3. Clone your newly created repo: `https://github.com/<%your_github_username%>/core-js-promises/`
4. Go to folder `core-js-promises`
...
4. Select your task (Core JS Promises)
...
The task based on https://github.com/mikhama/core-js-101/blob/master/src/06-promises-tasks.js
